...
KeccakF1600_StatePer::KeccakF1600_StatePer(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_437_reg_33245 );
    sensitive << ( tmp_438_reg_33250 );
