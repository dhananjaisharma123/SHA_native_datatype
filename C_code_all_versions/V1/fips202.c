                          ...
                          uint8_t p)
{
  ...
  uint8_t ff;
  //while(mlen >= r) {
    for(ff=3;ff>=SHA3_256_RATE;ff=ff-SHA3_256_RATE){
...
*              - size_t inlen:      length of input in bytes
**************************************************/
void sha3_256(uint8_t h[32], const uint8_t in[3], size_t inlen)
{
  unsigned int i;
  uint64_t s[25];
...
*              - size_t inlen:      length of input in bytes
**************************************************/
void sha3_512(uint8_t h[64], const uint8_t in[2], size_t inlen)
{
  unsigned int i;
  uint64_t s[25];
