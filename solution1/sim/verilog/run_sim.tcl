...
if {[file isfile pqcrystals_fips202_ref_sha3_512.autotvin.dat]} {
	file delete -force pqcrystals_fips202_ref_sha3_512.autotvin.dat
}

if {[file isfile pqcrystals_fips202_ref_sha3_512.autotvout.dat]} {
	file delete -force pqcrystals_fips202_ref_sha3_512.autotvout.dat
}
