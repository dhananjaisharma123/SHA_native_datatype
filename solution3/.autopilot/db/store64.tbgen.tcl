...
set C_modelName {store64}
set C_modelType { void 0 }
set C_modelArgList {
	{ x int 8 regular {array 136 { 0 0 } 0 1 }  }
...
set portList { 
	...
	{ x_offset sc_in sc_lv 9 signal 1 } 
...
set Spec2ImplPortList { 
	x { ap_memory {  { x_address0 mem_address 1 8 }  { x_ce0 mem_ce 1 1 }  { x_we0 mem_we 1 1 }  { x_d0 mem_din 1 8 }  { x_address1 MemPortADDR2 1 8 }  { x_ce1 MemPortCE2 1 1 }  { x_we1 MemPortWE2 1 1 }  { x_d1 MemPortDIN2 1 8 } } }
