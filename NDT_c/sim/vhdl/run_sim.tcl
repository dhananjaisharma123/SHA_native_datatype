...
if {[file isfile pqcrystals_fips202_ref_sha3_256.autotvin.dat]} {
	file delete -force pqcrystals_fips202_ref_sha3_256.autotvin.dat
}

if {[file isfile pqcrystals_fips202_ref_sha3_256.autotvout.dat]} {
	file delete -force pqcrystals_fips202_ref_sha3_256.autotvout.dat
}
