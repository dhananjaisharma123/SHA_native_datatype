...
set C_modelArgList {
	{ s int 64 regular {array 25 { 0 2 } 1 1 }  }
...
set portList { 
	...
	{ m_address0 sc_out sc_lv 2 signal 1 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "294", "Max" : "299"}
	, {"Name" : "Interval", "Min" : "294", "Max" : "299"}
]}
...
set Spec2ImplPortList { 
	s { ap_memory {  { s_address0 mem_address 1 5 }  { s_ce0 mem_ce 1 1 }  { s_we0 mem_we 1 1 }  { s_d0 mem_din 1 64 }  { s_address1 MemPortADDR2 1 5 }  { s_ce1 MemPortCE2 1 1 }  { s_we1 MemPortWE2 1 1 }  { s_d1 MemPortDIN2 1 64 }  { s_q1 MemPortDOUT2 0 64 } } }
