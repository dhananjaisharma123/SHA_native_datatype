...
architecture STRUCTURE of bd_0 is
  ...
  signal hls_inst_in_r_address0 : STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  attribute X_INTERFACE_PARAMETER of ap_clk : signal is "XIL_INTERFACENAME CLK.AP_CLK, ASSOCIATED_RESET ap_rst, CLK_DOMAIN bd_0_ap_clk_0, FREQ_HZ 66000000.0, INSERT_VIP 0, PHASE 0.000";
...
begin
  ...
  in_r_address0(1 downto 0) <= hls_inst_in_r_address0(1 downto 0);
