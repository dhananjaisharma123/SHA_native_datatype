...
architecture behav of pqcrystals_fips202_ref_sha3_256 is 
    ...
    "pqcrystals_fips202_ref_sha3_256,hls_ip_2018_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7a75tlftg256-2l,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.440000,HLS_SYN_LAT=464,HLS_SYN_TPT=none,HLS_SYN_MEM=8,HLS_SYN_DSP=0,HLS_SYN_FF=3741,HLS_SYN_LUT=20380,HLS_VERSION=2018_3}";
    ...
    signal i_4_i_fu_821_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal i_4_i_reg_995 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal tmp_i_5_fu_815_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_4_i_fu_832_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_4_i_reg_1015 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_CS_fsm_state6 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state6 : signal is "none";
    signal tmp_4_2_i_i_reg_1025 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_4_3_i_i_reg_1030 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_4_4_i_i_reg_1035 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_4_5_i_i_reg_1040 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_4_6_i_i_reg_1045 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_4_7_i_i_reg_1050 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal grp_KeccakF1600_StatePer_fu_800_ap_start : STD_LOGIC;
    signal grp_KeccakF1600_StatePer_fu_800_ap_done : STD_LOGIC;
    signal grp_KeccakF1600_StatePer_fu_800_ap_idle : STD_LOGIC;
    signal grp_KeccakF1600_StatePer_fu_800_ap_ready : STD_LOGIC;
    signal grp_KeccakF1600_StatePer_fu_800_state_address0 : STD_LOGIC_VECTOR (4 downto 0);
    signal grp_KeccakF1600_StatePer_fu_800_state_ce0 : STD_LOGIC;
    signal grp_KeccakF1600_StatePer_fu_800_state_we0 : STD_LOGIC;
    signal grp_KeccakF1600_StatePer_fu_800_state_d0 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_KeccakF1600_StatePer_fu_800_state_address1 : STD_LOGIC_VECTOR (4 downto 0);
    signal grp_KeccakF1600_StatePer_fu_800_state_ce1 : STD_LOGIC;
    signal grp_KeccakF1600_StatePer_fu_800_state_we1 : STD_LOGIC;
    signal grp_KeccakF1600_StatePer_fu_800_state_d1 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_keccak_absorb_fu_807_ap_start : STD_LOGIC;
    signal grp_keccak_absorb_fu_807_ap_done : STD_LOGIC;
    signal grp_keccak_absorb_fu_807_ap_idle : STD_LOGIC;
    signal grp_keccak_absorb_fu_807_ap_ready : STD_LOGIC;
    signal grp_keccak_absorb_fu_807_s_address0 : STD_LOGIC_VECTOR (4 downto 0);
    signal grp_keccak_absorb_fu_807_s_ce0 : STD_LOGIC;
    signal grp_keccak_absorb_fu_807_s_we0 : STD_LOGIC;
    signal grp_keccak_absorb_fu_807_s_d0 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_keccak_absorb_fu_807_s_address1 : STD_LOGIC_VECTOR (4 downto 0);
    signal grp_keccak_absorb_fu_807_s_ce1 : STD_LOGIC;
    signal grp_keccak_absorb_fu_807_s_we1 : STD_LOGIC;
    signal grp_keccak_absorb_fu_807_s_d1 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_keccak_absorb_fu_807_m_address0 : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_keccak_absorb_fu_807_m_ce0 : STD_LOGIC;
    signal i_i_reg_788 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal ap_CS_fsm_state9 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state9 : signal is "none";
    signal grp_KeccakF1600_StatePer_fu_800_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal grp_keccak_absorb_fu_807_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal tmp_6_i_fu_827_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_5_i_fu_840_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sum_1_i_i5_cast_fu_867_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sum_2_i_i6_cast_fu_937_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_CS_fsm_state7 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state7 : signal is "none";
    signal sum_3_i_i7_cast_fu_947_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sum_4_i_i8_cast_fu_957_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_CS_fsm_state8 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state8 : signal is "none";
    signal sum_5_i_i9_cast_fu_967_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sum_6_i_i_cast_fu_977_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sum_7_i_i_cast_fu_987_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_CS_fsm_state25 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state25 : signal is "none";
    signal tmp_fu_845_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal sum_1_i_i5_fu_861_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal sum_2_i_i6_fu_932_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal sum_3_i_i7_fu_942_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal sum_4_i_i8_fu_952_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal sum_5_i_i9_fu_962_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal sum_6_i_i_fu_972_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal sum_7_i_i_fu_982_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    grp_KeccakF1600_StatePer_fu_800 : component KeccakF1600_StatePer
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_keccak_absorb_fu_807 : component keccak_absorb
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_KeccakF1600_StatePer_fu_800_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((grp_KeccakF1600_StatePer_fu_800_ap_ready = ap_const_logic_1)) then 
                    grp_KeccakF1600_StatePer_fu_800_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    grp_keccak_absorb_fu_807_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((grp_keccak_absorb_fu_807_ap_ready = ap_const_logic_1)) then 
                    grp_keccak_absorb_fu_807_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    i_i_reg_788_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
                i_i_reg_788 <= i_4_i_reg_995;
            elsif (((grp_KeccakF1600_StatePer_fu_800_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state6)) then
                tmp_4_2_i_i_reg_1025 <= s_q0(23 downto 16);
                tmp_4_3_i_i_reg_1030 <= s_q0(31 downto 24);
                tmp_4_4_i_i_reg_1035 <= s_q0(39 downto 32);
                tmp_4_5_i_i_reg_1040 <= s_q0(47 downto 40);
                tmp_4_6_i_i_reg_1045 <= s_q0(55 downto 48);
                tmp_4_7_i_i_reg_1050 <= s_q0(63 downto 56);
                    tmp_4_i_reg_1015(7 downto 3) <= tmp_4_i_fu_832_p3(7 downto 3);
            end if;
        end if;
    end process;
    tmp_4_i_reg_1015(2 downto 0) <= "000";

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state5, tmp_i_5_fu_815_p2, grp_KeccakF1600_StatePer_fu_800_ap_done, grp_keccak_absorb_fu_807_ap_done, ap_CS_fsm_state4, ap_CS_fsm_state2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((grp_keccak_absorb_fu_807_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
            ...
            when ap_ST_fsm_state4 => 
                if (((grp_KeccakF1600_StatePer_fu_800_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                    ap_NS_fsm <= ap_ST_fsm_state5;
                else
                    ap_NS_fsm <= ap_ST_fsm_state4;
                end if;
            when ap_ST_fsm_state5 => 
                if (((tmp_i_5_fu_815_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then
    ...
    grp_KeccakF1600_StatePer_fu_800_ap_start <= grp_KeccakF1600_StatePer_fu_800_ap_start_reg;
    grp_keccak_absorb_fu_807_ap_start <= grp_keccak_absorb_fu_807_ap_start_reg;
    ...
    i_4_i_fu_821_p2 <= std_logic_vector(unsigned(i_i_reg_788) + unsigned(ap_const_lv5_1));
    in_r_address0 <= grp_keccak_absorb_fu_807_m_address0;
    in_r_ce0 <= grp_keccak_absorb_fu_807_m_ce0;

    out_assign_address0_assign_proc : process(ap_CS_fsm_state5, ap_CS_fsm_state6, ap_CS_fsm_state10, ap_CS_fsm_state11, ap_CS_fsm_state12, ap_CS_fsm_state13, ap_CS_fsm_state14, ap_CS_fsm_state15, ap_CS_fsm_state16, ap_CS_fsm_state17, ap_CS_fsm_state18, ap_CS_fsm_state19, ap_CS_fsm_state20, ap_CS_fsm_state21, ap_CS_fsm_state22, ap_CS_fsm_state23, ap_CS_fsm_state24, ap_CS_fsm_state9, tmp_5_i_fu_840_p1, sum_2_i_i6_cast_fu_937_p1, ap_CS_fsm_state7, sum_4_i_i8_cast_fu_957_p1, ap_CS_fsm_state8, sum_6_i_i_cast_fu_977_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state24)) then 
            ...
            out_assign_address0 <= sum_6_i_i_cast_fu_977_p1(8 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
            out_assign_address0 <= sum_4_i_i8_cast_fu_957_p1(8 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state7)) then 
            out_assign_address0 <= sum_2_i_i6_cast_fu_937_p1(8 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            out_assign_address0 <= tmp_5_i_fu_840_p1(8 - 1 downto 0);
    ...
    out_assign_address1_assign_proc : process(ap_CS_fsm_state5, ap_CS_fsm_state6, ap_CS_fsm_state10, ap_CS_fsm_state11, ap_CS_fsm_state12, ap_CS_fsm_state13, ap_CS_fsm_state14, ap_CS_fsm_state15, ap_CS_fsm_state16, ap_CS_fsm_state17, ap_CS_fsm_state18, ap_CS_fsm_state19, ap_CS_fsm_state20, ap_CS_fsm_state21, ap_CS_fsm_state22, ap_CS_fsm_state23, ap_CS_fsm_state24, ap_CS_fsm_state9, sum_1_i_i5_cast_fu_867_p1, ap_CS_fsm_state7, sum_3_i_i7_cast_fu_947_p1, ap_CS_fsm_state8, sum_5_i_i9_cast_fu_967_p1, sum_7_i_i_cast_fu_987_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state24)) then 
            ...
            out_assign_address1 <= sum_7_i_i_cast_fu_987_p1(8 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
            out_assign_address1 <= sum_5_i_i9_cast_fu_967_p1(8 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state7)) then 
            out_assign_address1 <= sum_3_i_i7_cast_fu_947_p1(8 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            out_assign_address1 <= sum_1_i_i5_cast_fu_867_p1(8 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
    ...
    out_assign_d0_assign_proc : process(ap_CS_fsm_state6, tmp_4_2_i_i_reg_1025, tmp_4_4_i_i_reg_1035, tmp_4_6_i_i_reg_1045, ap_CS_fsm_state9, ap_CS_fsm_state7, ap_CS_fsm_state8, tmp_fu_845_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
    ...
    out_assign_d1_assign_proc : process(ap_CS_fsm_state6, tmp_4_3_i_i_reg_1030, tmp_4_5_i_i_reg_1040, tmp_4_7_i_i_reg_1050, s_q0, ap_CS_fsm_state9, ap_CS_fsm_state7, ap_CS_fsm_state8)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
    ...
    s_address0_assign_proc : process(ap_CS_fsm_state5, grp_KeccakF1600_StatePer_fu_800_state_address0, grp_keccak_absorb_fu_807_s_address0, ap_CS_fsm_state4, ap_CS_fsm_state2, tmp_6_i_fu_827_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
            s_address0 <= tmp_6_i_fu_827_p1(5 - 1 downto 0);
    ...
    s_address1_assign_proc : process(grp_KeccakF1600_StatePer_fu_800_state_address1, grp_keccak_absorb_fu_807_s_address1, ap_CS_fsm_state4, ap_CS_fsm_state2)
    begin
    ...
    s_ce0_assign_proc : process(ap_CS_fsm_state5, grp_KeccakF1600_StatePer_fu_800_state_ce0, grp_keccak_absorb_fu_807_s_ce0, ap_CS_fsm_state4, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
    ...
    s_ce1_assign_proc : process(grp_KeccakF1600_StatePer_fu_800_state_ce1, grp_keccak_absorb_fu_807_s_ce1, ap_CS_fsm_state4, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            s_ce1 <= grp_keccak_absorb_fu_807_s_ce1;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    s_d0_assign_proc : process(grp_KeccakF1600_StatePer_fu_800_state_d0, grp_keccak_absorb_fu_807_s_d0, ap_CS_fsm_state4, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            s_d0 <= grp_keccak_absorb_fu_807_s_d0;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    s_d1_assign_proc : process(grp_KeccakF1600_StatePer_fu_800_state_d1, grp_keccak_absorb_fu_807_s_d1, ap_CS_fsm_state4, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            s_d1 <= grp_keccak_absorb_fu_807_s_d1;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    s_we0_assign_proc : process(grp_KeccakF1600_StatePer_fu_800_state_we0, grp_keccak_absorb_fu_807_s_we0, ap_CS_fsm_state4, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            s_we0 <= grp_keccak_absorb_fu_807_s_we0;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    s_we1_assign_proc : process(grp_KeccakF1600_StatePer_fu_800_state_we1, grp_keccak_absorb_fu_807_s_we1, ap_CS_fsm_state4, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            s_we1 <= grp_keccak_absorb_fu_807_s_we1;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    sum_1_i_i5_cast_fu_867_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sum_1_i_i5_fu_861_p2),64));
    sum_1_i_i5_fu_861_p2 <= (tmp_4_i_fu_832_p3 or ap_const_lv8_1);
    sum_2_i_i6_cast_fu_937_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sum_2_i_i6_fu_932_p2),64));
    sum_2_i_i6_fu_932_p2 <= (tmp_4_i_reg_1015 or ap_const_lv8_2);
    sum_3_i_i7_cast_fu_947_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sum_3_i_i7_fu_942_p2),64));
    sum_3_i_i7_fu_942_p2 <= (tmp_4_i_reg_1015 or ap_const_lv8_3);
    sum_4_i_i8_cast_fu_957_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sum_4_i_i8_fu_952_p2),64));
    sum_4_i_i8_fu_952_p2 <= (tmp_4_i_reg_1015 or ap_const_lv8_4);
    sum_5_i_i9_cast_fu_967_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sum_5_i_i9_fu_962_p2),64));
    sum_5_i_i9_fu_962_p2 <= (tmp_4_i_reg_1015 or ap_const_lv8_5);
    sum_6_i_i_cast_fu_977_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sum_6_i_i_fu_972_p2),64));
    sum_6_i_i_fu_972_p2 <= (tmp_4_i_reg_1015 or ap_const_lv8_6);
    sum_7_i_i_cast_fu_987_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sum_7_i_i_fu_982_p2),64));
    sum_7_i_i_fu_982_p2 <= (tmp_4_i_reg_1015 or ap_const_lv8_7);
    tmp_4_i_fu_832_p3 <= (i_i_reg_788 & ap_const_lv3_0);
    tmp_5_i_fu_840_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_4_i_fu_832_p3),64));
    tmp_6_i_fu_827_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_i_reg_788),64));
    tmp_fu_845_p1 <= s_q0(8 - 1 downto 0);
    tmp_i_5_fu_815_p2 <= "1" when (i_i_reg_788 = ap_const_lv5_11) else "0";
end behav;
