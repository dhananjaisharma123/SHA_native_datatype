...
#pragma line 7 "/home/ds6365/fips202.h" 2
#pragma empty_line
#pragma empty_line
#pragma empty_line
#pragma empty_line
...
#pragma empty_line
#pragma empty_line
void pqcrystals_fips202_ref_shake128_absorb(keccak_state *state, const uint8 *in, size_t inlen);
#pragma empty_line
void pqcrystals_fips202_ref_shake128_squeezeblocks(uint8 *out, size_t nblocks, keccak_state *state);
#pragma empty_line
#pragma empty_line
void pqcrystals_fips202_ref_shake256_absorb(keccak_state *state, const uint8 *in, size_t inlen);
#pragma empty_line
void pqcrystals_fips202_ref_shake256_squeezeblocks(uint8 *out, size_t nblocks, keccak_state *state);
#pragma empty_line
void pqcrystals_fips202_ref_shake128(uint8 *out, size_t outlen, const uint8 *in, size_t inlen);
#pragma empty_line
void pqcrystals_fips202_ref_shake256(uint8 *out, size_t outlen, const uint8 *in, size_t inlen);
#pragma empty_line
void pqcrystals_fips202_ref_sha3_256(uint8 h[32], const uint8 in[3], size_t inlen);
#pragma empty_line
void pqcrystals_fips202_ref_sha3_512(uint8 h[64], const uint8 *in, size_t inlen);
#pragma line 11 "/home/ds6365/fips202.c" 2
#pragma empty_line
#pragma empty_line
#pragma empty_line
uint8 h[64];
#pragma line 24 "/home/ds6365/fips202.c"
...
#pragma line 42 "/home/ds6365/fips202.c"
...
#pragma line 85 "/home/ds6365/fips202.c"
...
#pragma line 363 "/home/ds6365/fips202.c"
...
#pragma line 408 "/home/ds6365/fips202.c"
...
#pragma line 437 "/home/ds6365/fips202.c"
void pqcrystals_fips202_ref_shake128_absorb(keccak_state *state, const uint8 *in, size_t inlen)
{
  keccak_absorb(state->s, 168, in, inlen, 0x1F);
}
#pragma line 454 "/home/ds6365/fips202.c"
void pqcrystals_fips202_ref_shake128_squeezeblocks(uint8 *out, size_t nblocks, keccak_state *state)
{
  keccak_squeezeblocks(out, nblocks, state->s, 168);
}
#pragma line 469 "/home/ds6365/fips202.c"
void pqcrystals_fips202_ref_shake256_absorb(keccak_state *state, const uint8 *in, size_t inlen)
{
  keccak_absorb(state->s, 136, in, inlen, 0x1F);
}
#pragma line 486 "/home/ds6365/fips202.c"
void pqcrystals_fips202_ref_shake256_squeezeblocks(uint8 *out, size_t nblocks, keccak_state *state)
{
  keccak_squeezeblocks(out, nblocks, state->s, 136);
}
#pragma line 501 "/home/ds6365/fips202.c"
void pqcrystals_fips202_ref_shake128(uint8 *out, size_t outlen, const uint8 *in, size_t inlen)
{
  unsigned int i;
...
#pragma line 531 "/home/ds6365/fips202.c"
void pqcrystals_fips202_ref_shake256(uint8 *out, size_t outlen, const uint8 *in, size_t inlen)
{
  unsigned int i;
...
#pragma line 560 "/home/ds6365/fips202.c"
void pqcrystals_fips202_ref_sha3_256(uint8 h[32], const uint8 in[3], size_t inlen)
{
  uint6 i;
  uint64 s[25];
...
#pragma line 582 "/home/ds6365/fips202.c"
void pqcrystals_fips202_ref_sha3_512(uint8 h[64], const uint8 in[2], size_t inlen)
{
  unsigned int i;
  uint64 s[25];
  uint8 t[72];
