...
#pragma empty_line
  ...
  uint8 ff;
#pragma empty_line
    keccak_absorb_label7:for(ff=mlen;ff>=136;ff=ff-136)
    {
...
#pragma empty_line
    keccak_absorb_label5:for(i=0;i<17;i++)
     s[i] ^= load64(t + 8*i);
#pragma line 413 "/home/ds6365/fips202.c"
}
#pragma line 427 "/home/ds6365/fips202.c"
                                 ...
                                 unsigned int r)
{
  uint6 i;
  int kk ;
#pragma line 444 "/home/ds6365/fips202.c"
  while(nblocks > 0)
  {
      KeccakF1600_StatePermute(s);
      for(i=0;i<r/8;i++)
...
void pqcrystals_fips202_ref_sha3_256(uint8 h[32], const uint8 IN[4096], size_t inlen)
{
  uint6 i;
  uint11 j;
  uint64 s[25];
