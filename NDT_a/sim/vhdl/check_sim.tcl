...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.pqcrystals_fips202_ref_sha3_256.autotvin_h.dat"
         "c.pqcrystals_fips202_ref_sha3_256.autotvin_IN_r.dat"
         "c.pqcrystals_fips202_ref_sha3_256.autotvin_inlen.dat"
         "c.pqcrystals_fips202_ref_sha3_256.autotvout_h.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.pqcrystals_fips202_ref_sha3_256.autotvout_h.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
