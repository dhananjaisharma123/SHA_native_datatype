...
uint8 h[64];
# 24 "fips202.c"
static uint64 load64(const uint8 x[8]) {_ssdm_SpecArrayDimSize(x, 8);
  uint4 i;
  uint64 r = 0;
...
# 42 "fips202.c"
static void store64(uint8 x[8], uint64 u) {_ssdm_SpecArrayDimSize(x, 8);
  uint4 i;
...
{_ssdm_SpecArrayDimSize(h, 32);_ssdm_SpecArrayDimSize(IN, 4096);
  uint6 i;
  uint11 j;
  uint64 s[25];
  uint8 t[136];
